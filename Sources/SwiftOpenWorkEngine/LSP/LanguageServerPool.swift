...
public actor LanguageServerPool {
    ...
    public static let crashWindow: TimeInterval = 300

    public init(locator: ExecutableLocator = ExecutableLocator(), idleTimeout: TimeInterval = 600) {
    ...
    public func stopIdleServers() async {
