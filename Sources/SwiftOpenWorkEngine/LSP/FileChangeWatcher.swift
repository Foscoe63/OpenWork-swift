...
public final class FileChangeWatcher: @unchecked Sendable {
    public typealias Handler = @Sendable ([(path: String, change: SessionEvents.FileChange)]) -> Void
    ...
    public init?(root: String, latency: TimeInterval = 0.2, handler: @escaping Handler) {
    ...
    public static func classify(flags: Int, exists: Bool) -> SessionEvents.FileChange {
    ...
    public static func isRelevant(_ path: String, root: String, spec: LanguageServerSpec) -> Bool {
