...
public actor SymbolIndex {
    ...
    public static func scan(path: String, content: String, ext: String) -> [Symbol] {
    ...
    public static func blockCommentDepth(after line: String, startingAt depth: Int, ext: String) -> Int {
