...
public final class LiveToolOutput: ObservableObject {
    ...
    public static let maxTailLines = 24
    public static let maxTailCharacters = 4_000
    ...
    public nonisolated static func publish(chunk: String, callId: String?) {
        guard !chunk.isEmpty else { return }
        Task { @MainActor in
    ...
    public nonisolated static func note(_ line: String, callId: String?) {
    ...
    public nonisolated static func conclude(noteFor callId: String) {
        Task { @MainActor in shared.finish(callId: callId) }
    }

    public nonisolated static func announce(command: String, callId: String?) {
        Task { @MainActor in
    ...
    public nonisolated static func conclude(callId: String?, exitCode: Int32) {
        Task { @MainActor in
