...
public struct InlineSuggestionRequest: Equatable, Sendable {
    ...
    public static let prefixLimit = 3_000
    public static let suffixLimit = 1_000
...
public enum InlineSuggestionCleaner {
    ...
    public static func dropOverlap(of linePrefix: String, from text: String) -> String {
...
public final class InlineSuggestionEngine: ObservableObject {
    ...
    public static func choice() -> InlineSuggestionModelChoice {
        guard let app = EngineHosting.host else { return .disabled }
