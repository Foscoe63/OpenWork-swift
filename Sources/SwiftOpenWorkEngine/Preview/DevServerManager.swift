...
public final class DevServer: ObservableObject, Identifiable {
    ...
    public var staticServer: StaticFileServer?
    private var partialLine = ""
    public static let maxLogLines = 2_000

    public init(command: String, workingDirectory: String, isStaticServer: Bool) {
...
public final class DevServerManager: ObservableObject {
    ...
    public nonisolated static func processTree(of pid: Int32) -> [Int32] {
        let output = runQuick("/bin/ps", ["-A", "-o", "pid=,ppid="]) ?? ""
        return ProcessTree.descendants(of: pid, in: ProcessTree.parse(psOutput: output))
    }

    public nonisolated static func listeningPorts(ofProcessTree pid: Int32) async -> [Int] {
    ...
    public nonisolated static func parseListeningPorts(lsofOutput: String) -> [Int] {
        var ports: [Int] = []
    ...
    public nonisolated static func responds(_ url: URL) async -> Bool {
    ...
    /// be checked.
    public nonisolated static func runQuick(_ executable: String, _ arguments: [String], timeout: TimeInterval = 5) -> String? {
        let process = Process()
    ...
    public nonisolated static func extractMarkedPath(_ output: String) -> String? {
    ...
    public nonisolated static func mergePaths(primary: String, secondary: String) -> String {
        var seen = Set<String>()
        var result: [String] = []
