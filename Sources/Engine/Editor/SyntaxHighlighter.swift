...
struct LanguageRules {
    ...
    var multilineDelimiters: Set<String> = []
    ...
    var bracketSections = false
    var identifierExtraChars: Set<UInt16> = []

    static func rules(for language: SyntaxLanguage) -> LanguageRules {
        var r = LanguageRules()
        switch language {
        case .swift:
            r.lineComments = ["//"]
