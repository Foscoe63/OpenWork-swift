...
public enum UpdateChecker {
    ...
    static let lastCheckKey = "SwiftOpenWork.updates.lastAutomaticCheck"
    ...
    @MainActor
    public static func runAutomaticCheckIfDue(appState: AppState) {
        guard Bundle.main.bundleIdentifier != nil, !AutomationScheduler.isHostedByTests else { return }
