...
public enum XcodeBuildServer {
    ...
    static let sourceExtensions: Set<String> = ["swift", "m", "mm", "h", "c", "cc", "cpp", "hpp", "metal"]
    ...
    static func latestBuildLog(buildRoot: String, fileManager: FileManager = .default) -> Date? {
    ...
    static func notes(forRoot root: String) -> [String] {
    ...
    static func xcodeProjectDirectory(containing file: String, workspaceRoot: String, listDirectory: (String) -> [String]) -> String? {
    ...
    static func configCommand(executable: String, developerDirectory: String?, flag: String, container: String, scheme: String) -> String {
        var parts: [String] = []
    ...
    static func buildCommand(developerDirectory: String?, flag: String, container: String, scheme: String) -> String {
        var parts: [String] = []
        if let developerDirectory { parts.append("DEVELOPER_DIR=\(BuildDiagnostics.quoted(developerDirectory))") }
    ...
    static let installHint = "Install it with: brew install xcode-build-server"
}
