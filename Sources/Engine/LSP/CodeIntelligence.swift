...
public enum CodeIntelligence {
    ...
    struct Context {
        ...
        let uri: String
        let position: SymbolPosition.Resolved
        let subject: String
        let header: String

        var positionParams: [String: Any] {
    ...
    static func absolutePath(_ path: String, workspaceRoot: String) -> String {
    ...
    struct Location: Hashable, Comparable {
        ...
        init?(uri: String, range: [String: Any]) {
    ...
    static func parseLocations(_ value: Any?) -> [Location] {
    ...
    static func formatLocations(_ locations: [Location], workspaceRoot: String) -> [String] {
    ...
    static func hoverText(_ value: Any?) -> String {
    ...
    static func formatOutline(_ value: Any?) -> [String] {
