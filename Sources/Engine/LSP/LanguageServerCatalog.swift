...
public enum LanguageServerCatalog {
    ...
    static func projectRoot(for file: String, workspaceRoot: String, markers: [String], fileExists: (String) -> Bool) -> String? {
...
public struct ExecutableLocator: Sendable {
    ...
    var bundleVersion: @Sendable (String) -> String?
    /// Where `xcode-select` points, which is what `xcode-select -p` reads.
    var selectedDeveloperDirectory: @Sendable () -> String?
    ...
    func locate(_ spec: LanguageServerSpec, projectRoot: String? = nil) -> Located? {
    ...
    func sourceKitInXcode() -> (String, String)? {
